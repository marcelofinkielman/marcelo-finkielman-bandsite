  ...
  axios
    ...
    .then((res) => {
      ...
      showsArray.forEach(arrayIndex => {
        ...
        const justDate = document.createElement('p')
        justDate.classList.add('tickets__mainVenueTitle')
        justDate.innerText = 'DATE'
        newShowContainer.appendChild(justDate)
        ...
        const justVenue = document.createElement('p')
        justVenue.classList.add('tickets__mainLocationTitle')
        justVenue.innerText = 'VENUE'
        newShowContainer.appendChild(justVenue)
        ...
        const justLocation = document.createElement('p')
        justLocation.classList.add('tickets__mainLocationTitle')
        justLocation.innerText = 'LOCATION'
        newShowContainer.appendChild(justLocation)
